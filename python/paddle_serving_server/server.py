...
class Server(object):
    ...
    def _prepare_resource(self, workdir, cube_conf):
        ...
        if self.resource_conf == None:
            ...
            for idx, op_general_model_config_fn in enumerate(
                ...
                with open("{}/{}".format(workdir, op_general_model_config_fn), "w") as fout:
    ...
    def download_bin(self):
        ...
        folder_name = "serving-%s-%s" % (self.get_serving_bin_name(), version_tag)
        ...
        download_flag = "{}/{}.is_download".format(self.module_path, folder_name)
    ...
    def prepare_server(self,
        ...
        self._prepare_engine(self.model_config_paths, device, use_encryption_model)
